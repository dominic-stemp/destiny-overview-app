...
def generate_ra_pdf(field_values: dict, alloc_df=None) -> bytes:
    ...
    for b in [
        ...
        "<b>Access pre-retirement</b><br/>Retirement from the Fund is only permitted from age 55, unless you are permanently disabled or you have formally emigrated and remained non-resident for a continuous period of at least three years, or the value of your benefit is below the prescribed minimum at the time. You may make one full or partial withdrawal from the Savings component of at least R2 000 each tax year. Withdrawals made before retirement will be taxed at your marginal tax rate.",
        "<b>Access at retirement</b><br/>You can take up to 100% of your vested component and savings component as a lump sum when you retire. You can take up to one-third of your non-vested component as a lump sum when you retire. You must use the full value of your retirement component to purchase an annuity when you retire. If the combined value of two-thirds of the vested component (non-vested benefit and the retirement components) is less than the minimum prescribed amount at the time, you can take the full amount as a lump sum at retirement.",
