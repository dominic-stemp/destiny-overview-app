...
def generate_pres_pdf(field_values: dict, alloc_df=None, investor_age: float = 0) -> bytes:
    ...
    for b in [
        "The Retirement Preservation Option offers a tax-efficient way to preserve your employer retirement fund benefits when you leave your employer, while also allowing you to consolidate benefits held in existing preservation funds.",
